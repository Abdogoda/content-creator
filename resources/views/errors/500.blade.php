      ...
      <div class="col-md-6">
       <div class="services__title">
        <div class="section-title">
         ...
         <h2>{{__('errors.500_internal_server_error')}}</h2>
        </div>
            <p>{{__('errors.500_description')}}</p>
        <a href={{url('/')}} class="primary-btn">{{__('errors.go_home')}}</a>
       </div>
      </div>
      <div class="col-md-6 d-flex justify-content-center">
        <img class="error-image" style="width: 80%" src={{asset('assets/frontend/img/errors/500.svg')}} alt="error-500-image">
     </div>
     </div>
    </div>
  </section>
