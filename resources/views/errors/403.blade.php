...
<html lang="zxx">
 <head>
  ...
  <title>{{__('errors.403_forbidden')}}</title>
    ...
    <div class="container">
     <div class="row">
      ...
      <div class="col-md-6 d-flex justify-content-center">
        <img class="error-image" style="width: 80%" src={{asset('assets/frontend/img/errors/403.svg')}} alt="error-403-image">
     </div>
     </div>
    </div>
  </section>
