<!-- Modal -->
<div class="modal fade" id="addServiceImageWork" tabindex="-1" aria-labelledby="addServiceWorkImgeLabel" aria-hidden="true">
    ...
    <form action="{{\LaravelLocalization::localizeURL('/admin/services/add-work')}}" method="post" enctype="multipart/form-data" id="add-work">
     ...
     <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addServiceWorkImageLabel">{{__('services.add_image')}}</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
       <input type="hidden" name="id" value="{{$service->id}}">
       <input type="hidden" name="attachment_type" value="image">
